// Ported from BloogBot/FrostMageBot/FrostMageConsumables.cs (.NET Framework 4.8 -> .NET 9). Replica - do not redesign.
using System;
...
namespace FrostMageBot
{
    static class FrostMageConsumables
    {
        ...
        internal static readonly string[] ConjuredFoodNames =
        {
            ...
            // WotLK mage consumables that restore mana as well as health. Upstream's list is
            // Vanilla-only; these are the highest level items, so they belong at the end.
            "Conjured Mana Pie",
...
#if USE_CUSTOM_CHANGES
            // See the food list above - these restore mana and count as drink too.
            "Conjured Mana Pie",
            "Conjured Mana Strudel",
            "Conjured Mana Biscuit"
#endif
