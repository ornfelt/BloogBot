...
High-water mark: `9594a43` (every commit up to and including this one is decided)
...
Remaining after the high-water mark: `50`
...
None. The next run starts at `0f3ce40` ('WotLK: use buffs to determin eating/drinking status').
