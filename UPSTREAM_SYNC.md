...
High-water mark: `fc7c7fd` (every commit up to and including this one is decided)
...
Remaining after the high-water mark: `51`
...
None. The next run starts at `9594a43` ('Check for threat before looting').
